...
public class JanelaPrincipal extends javax.swing.JFrame {
    ...
    private void ButtonNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonNomeActionPerformed
        try{
                    String nome = "C://Users//joao_alves//Desktop//4º - Template Method//src//Arquivo/RelatorioDasEnfases.csv";
        OrdenarNome objeto = new OrdenarNome(nome);
    ...
    private void ButtonSobrenomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonSobrenomeActionPerformed
        try{
                    String sobrenome = "C://Users//joao_alves//Desktop//4º - Template Method//src//Arquivo/RelatorioDasEnfases.csv";
        OrdenarSobrenome objeto = new OrdenarSobrenome(sobrenome);
            imprimirNaGrid(objeto.listagem());
        }catch(Exception erro){
            JOptionPane.showMessageDialog(rootPane, erro);
        }
    ...
    private void ButtonCursoeNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonCursoeNomeActionPerformed
        try{
                    String curso = "C://Users//joao_alves//Desktop//4º - Template Method//src//Arquivo/RelatorioDasEnfases.csv";
        OrdenarCursoNome objeto = new OrdenarCursoNome(curso);
            imprimirNaGrid(objeto.listagem());
        }catch(Exception erro){
            JOptionPane.showMessageDialog(rootPane, erro);
        }
    ...
    private void ButtonEnfaseENomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonEnfaseENomeActionPerformed
        try{
                    String enfase = "C://Users//joao_alves//Desktop//4º - Template Method//src//Arquivo/RelatorioDasEnfases.csv";
        OrdenarEnfaseNome objeto = new OrdenarEnfaseNome(enfase);
            imprimirNaGrid(objeto.listagem());
        }catch(Exception erro){
            JOptionPane.showMessageDialog(rootPane, erro);
        }
    ...
    private void ButtonSituacaoCursoNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonSituacaoCursoNomeActionPerformed
        try{
                    String situacao = "C://Users//joao_alves//Desktop//4º - Template Method//src//Arquivo/RelatorioDasEnfases.csv";
        OrdenarSituacaoCursoNome objeto = new OrdenarSituacaoCursoNome(situacao);
            imprimirNaGrid(objeto.listagem());
        }catch(Exception erro){
            JOptionPane.showMessageDialog(rootPane, erro);
        }
    ...
    private void ButtonCursoEnfaseNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonCursoEnfaseNomeActionPerformed
        try{
                    String curso = "C://Users//joao_alves//Desktop//4º - Template Method//src//Arquivo/RelatorioDasEnfases.csv";
        OrdenarCursoEnfaseNome objeto = new OrdenarCursoEnfaseNome(curso);
            imprimirNaGrid(objeto.listagem());
        }catch(Exception erro){
            JOptionPane.showMessageDialog(rootPane, erro);
        }
